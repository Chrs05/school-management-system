...
class MonthlyFeeController extends Controller
{
 ...
 public function MonthlyFeeClassData(Request $request){
    	 ...
    	 foreach ($allStudent as $key => $v) {
    	 	...
    	 	$html[$key]['tdsource'] .='<a class="btn btn-sm btn-'.$color.'" title="PaySlip" target="_blanks" href="'.route("student.monthly.fee.payslip").'?class_id='.$v->class_id.'&student_id='.$v->student_id.'&month='.$request->month.'">Monthly Fee Slip</a>';
    	 	$html[$key]['tdsource'] .= '</td>';
