...
//commented because VS Code generates error
// use DB;
// DB use for vs code error workaround
...
class StudentRegController extends Controller
{
    ...
    public function ViewStudentRegister(){
    	...
    	return view('backend.student.student_register.student_view',$data);
    }
    ...
    public function StudentRegisterAdd() {
        ...
        return view('backend.student.student_register.student_register_add',$data);
    }
    ...
    public function StudentRegisterEdit($student_id){
    	...
    	return view('backend.student.student_register.student_register_edit',$data);
     ...
     public function StudentRegisterUpdate(Request $request,$student_id){
      ...
      public function StudentRegPromotion($student_id){
    	...
    	return view('backend.student.student_register.student_promotion',$data);
    ...
    public function StudentRegDetails($student_id){
        ...
        $pdf = PDF::loadView('backend.student.student_register.student_details_pdf', $data);
