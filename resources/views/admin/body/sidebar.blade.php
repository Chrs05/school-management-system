    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview {{ ($prefix == '/profile') ? 'active' : '' }}">
          <a href="#">
            <i data-feather="mail"></i> <span>Profiles</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview {{ ($prefix == '/setups') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('fee.category.view') }}"><i class="ti-more"></i>Student Fee</a></li>
            <li><a href="{{ route('fee.amount.view') }}"><i class="ti-more"></i>Student Amount Fee</a></li>
            <li><a href="{{ route('exam.type.view') }}"><i class="ti-more"></i>Student Exam Type</a></li>
        ...
        <li class="treeview {{ ($prefix == '/students') ? 'active' : '' }}">
          <a href="#">
            <i data-feather="mail"></i> <span>Students Management</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('role.generate.view') }}"><i class="ti-more"></i>Student Role Generate</a></li>
