                        ...
                        <tbody>
                          ...
                          @foreach ($allData as $key => $group)
                            <tr role="row" class="odd">
                              ...
                              <td>{{ $group->name }}</td>
                              <td>
                                <a href="{{ route('student.group.edit', $group->id) }}" class="btn btn-info">Edit Group</a>
                                <a href="{{ route('student.group.delete', $group->id) }}" id="delete" class="btn btn-danger">Delete Group</a>
                              </td>
                            </tr>
                          @endforeach
