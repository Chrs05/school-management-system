                        ...
                        <tbody>
                          ...
                          @foreach ($allData as $key => $student)
                            <tr role="row" class="odd">
                              ...
                              <td>{{ $student->name }}</td>
                              <td>
                                <a href="{{ route('student.class.edit', $student->id) }}" class="btn btn-info">Edit Class</a>
                                <a href="{{ route('student.class.delete', $student->id) }}" id="delete" class="btn btn-danger">Delete Class</a>
                              </td>
                            </tr>
                          @endforeach
