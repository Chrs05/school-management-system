                        ...
                        <tbody>
                          ...
                          @foreach ($allData as $key => $shift)
                            <tr role="row" class="odd">
                              ...
                              <td>{{ $shift->name }}</td>
                              <td>
                                <a href="{{ route('student.shift.edit', $shift->id) }}" class="btn btn-info">Edit Shift</a>
                                <a href="{{ route('student.shift.delete', $shift->id) }}" id="delete" class="btn btn-danger">Delete Shift</a>
                              </td>
                            </tr>
                          @endforeach
