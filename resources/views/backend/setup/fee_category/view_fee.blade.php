                        ...
                        <tbody>
                          ...
                          @foreach ($allData as $key => $fee)
                            <tr role="row" class="odd">
                              ...
                              <td>{{ $fee->name }}</td>
                              <td>
                                <a href="{{ route('fee.category.edit', $fee->id) }}" class="btn btn-info">Edit Fee</a>
                                <a href="{{ route('fee.category.delete', $fee->id) }}" id="delete" class="btn btn-danger">Delete Fee</a>
                              </td>
                            </tr>
                          @endforeach
